...
//    [NSTimer scheduledTimerWithTimeInterval:0.5 target:self selector:@selector(dismissAlertView:) userInfo:alertView repeats:NO];
...
+ (NSArray *)setupCustomActivityIndicator {
    ...
    for (int i = 1; i <= 20; i++) {
        UIImage *image = [UIImage imageNamed:[NSString stringWithFormat:@"%dA",i]];
